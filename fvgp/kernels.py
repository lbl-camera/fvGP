...
def wendland_anisotropic_gp2Scale_cpu_sparse(x1, x2, hps):
    ...
    This kernel preserves the usual kernel interface but performs block-local
    support checks and radius-search assembly internally, returning a sparse COO
    matrix directly. It is intended for gp2Scale workflows where the batchwise
    kernel is assembled on sparse blocks.
    """
